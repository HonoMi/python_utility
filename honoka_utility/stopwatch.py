'''
http://qiita.com/daisukelab/items/b05853829e229d7070f5
'''
# Stopwatch for casual profiling
...
class Stopwatch:
    ...
    def report(self):
        ...
        print_str = 'Duration:' + self.formatTotal('%H:%M:%S.%f=%T s') + lap_str + av_str
        print(print_str)
        return print_str
